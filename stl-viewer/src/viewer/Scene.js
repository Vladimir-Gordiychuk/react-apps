...
export default class Scene {
    ...
    get rotationMatrix() {
      ...
      mat4.rotate(matrix, matrix, this._rotation[0] * degresToRadians, [1, 0, 0]);
      mat4.rotate(matrix, matrix, this._rotation[1] * degresToRadians, [0, 1, 0]);
      mat4.rotate(matrix, matrix, this._rotation[2] * degresToRadians, [0, 0, 1]);
