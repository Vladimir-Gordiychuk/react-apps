export default class WireframeObject {
    ...
    static makeEdges(triangles) {
      ...
      for (let i = 0; i < triangleCount; ++i) {
        const a = [ triangles[i * 9  + 0], triangles[i * 9  + 1], triangles[i * 9  + 2] ];
        const b = [ triangles[i * 9  + 3], triangles[i * 9  + 4], triangles[i * 9  + 5] ];
        const c = [ triangles[i * 9  + 6], triangles[i * 9  + 7], triangles[i * 9  + 8] ];
